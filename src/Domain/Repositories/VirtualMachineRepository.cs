...
public class VirtualMachineRepository : IMachineRepository<IVirtualMachine>
{
    ...
    private void SeedData()
    {
        VirtualMachine vm1 = new VirtualMachine.VirtualMachineBuilder()
            ...
            .SetCredentials(new HashSet<Credentials>() { new("Admin", "password"), new("User", "password") })
        ...
        VirtualMachine vm2 = new VirtualMachine.VirtualMachineBuilder()
            ...
            .SetCredentials(new HashSet<Credentials>() { new("Admin", "password"), new("User", "password"), new("User2", "password") })
